    ...
    return (
        <div
            ...
            <li
                ...
                className=' rounded-md w-full h-8 items-center justify-center flex hover:cursor-pointer hover:bg-secondary-200 transition-all'>Perfil</li>
            <li className=' rounded-md w-full h-8 items-center justify-center flex hover:cursor-pointer hover:bg-secondary-200 transition-all'>Sair</li>
        </div>
    )
}
